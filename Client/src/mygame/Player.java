...
public class Player {
    ...
    public void Update(float tpf, Vector3f walkdir)
    {
        /*
        ...
        */
        ...
        Vector3f gravdir = new Vector3f(-gravity.x*gravspeed*tpf,-gravity.y*gravspeed*tpf,-gravity.z*gravspeed*tpf);
        Vector3f jumpdir = new Vector3f(jump.x*jumpspeed*tpf,jump.y*jumpspeed*tpf,jump.z*jumpspeed*tpf);
        walkdir.x*=tpf*walkspeed;walkdir.y*=tpf*walkspeed;walkdir.z*=tpf*walkspeed;
    ...
    private boolean MoveTo(Vector3f dir)
    {
